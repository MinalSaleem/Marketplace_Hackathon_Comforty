    ...
    <div className="bg-[#FFFFFF] flex flex-col px-4 md:px-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 mx-0 md:mx-10">
        <div className=" mt-10 w-full h-72 justify-center bg-[#007580] shadow-md shadow-slate-400">
          <h1 className="text-[#FFFFFF] font-bold mt-7 ml-10">
            About Us-Comforty
          </h1>
          <p className="text-[#FFFFFF] font-light mt-7 ml-10 px-5">
          ...
          <Link href={"/products"}>
          <button className=" text-[#FFFFFF] font-light mt-7 ml-10">
            View Collection
          </button>
          </Link>
        </div>
        ...
        <div className="w-full p-4 md:p-7 mt-10">
          <Image
            ...
            src="/products/1.png"
            alt="Chair"
            className="-mt-8 w-full h-72 justify-center"
          />
        </div>
      </div>
      {/*Brand different div */}
      <div className="mt-10">
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-between gap-6 mt-10">
          <div className="bg-[#F9F9F9] p-6 rounded-md shadow-md max-w-xs hover:scale-105 hover:z-10 transition-transform duration-150">
            <h1 className="text-[#007580] font-semibold">
        ...
        <div className="mt-10 ml-10">
          <h1 className="text-[#272343] font-bold text-2xl">
        ...
        <div className="flex justify-around items-center p-6 space-x-5">
          {products.map((product, index) => (
            <div
              key={index}
              className="w-64 border border-gray-300 rounded-md shadow-md p-4"
            >
              <Image
                src={product.image}
                width={300}
